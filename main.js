...
function readTxBufferFromS3File(fileName) {
...
function loadNextTransaction(ticketId) {
  const transactionResponse = await readTxBufferFromS3File(`${ticketId}.btx`)
  return transactionResponse
}

function selectWinner(initTransaction, finalizationTransaction, loadNextTicketSaleTransaction, pubKey) {
